...
func RegisterRealWorldHTTPServer(s *http.Server, srv RealWorldHTTPServer) {
	...
	r.POST("/api/articles/{slug}/comments", _RealWorld_GetComments0_HTTP_Handler(srv))
...
func (c *RealWorldHTTPClientImpl) GetTags(ctx context.Context, in *emptypb.Empty, opts ...http.CallOption) (*TagListReply, error) {
